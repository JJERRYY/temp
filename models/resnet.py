...
class ResNet(SimpleNet):
    def __init__(self, block, num_blocks, num_classes=10, name=None, created_time=None,num_channels=3):
    ...
    def intermediate_forward(self, x, target_layer):
...
def ResNet18(name=None, created_time=None, num_classes=10,num_channels=3):
    return ResNet(BasicBlock, [2,2,2,2],name='{0}_ResNet_18'.format(name), created_time=created_time, num_classes=num_classes,num_channels=num_channels)
